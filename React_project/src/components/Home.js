        ...
        <div>
          <nav className="navbar"> 
            ...
            <Link to='/Form'><li className="po"><a className="al" >Login</a></li></Link> 
             <li className="po"><a className="al" href="about.asp">About</a></li>
             <li className="po"><a className="al" href="contact.asp">Contact</a></li>
             <li className="po"><a className="al" href="default.asp">Home</a></li>
            </ul>
          </nav>
          <div className="first">
              <div className='photo'>
